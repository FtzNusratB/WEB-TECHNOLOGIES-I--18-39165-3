...
if (empty($_SESSION['username'])) {
    ...
    echo "<a class= 'button2' href='Images/Logout.php'>Logout</a>";
    echo "</div><hr><br><br>";
}
 ?>
 ...
 ?>
  ...
  <tr>
    <th>
      ...
      <div class="account">
      <a href="Dashboard.php"><img src="Images/logo1.jpg" width="50" height="50">Dashboard</a><br><br>
      <a href="Profile.php"><img src="Images/logo2.jpg" width="50" height="50">View Profile</a><br><br>
      <a href="ApplyForm.php"><img src="Images/logo3.jpg" width="50" height="50">Apply for Test</a><br><br>
      <a href="Report.php"><img src="Images/logo4.jpg" width="50" height="50">Report</a><br><br>
      <a href="Sources/Logout.php" ><img src="Images/logo5.jpg" width="50" height="40">Logout</a><br><br>
    </th></div>
